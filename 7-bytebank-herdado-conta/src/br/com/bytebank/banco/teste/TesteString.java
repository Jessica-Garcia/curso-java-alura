...
public class TesteString {
	...
	public static void main(String[] args) {
		...
		//para saber a letra que está em determinada posição da String
		
		char c = nome.charAt(2);
		System.out.println(c);
		
		// posição de determinada substring dentro da string
		...
		String sub = nome.substring(1); // vai imprimir da posição 1 em diante
		...
		// para saber se o string está vazio, devolve um boolean:
		
		String vazio = " ";
		System.out.println(vazio.isEmpty());
		
		// para tirar os espaços do inicio e fim de um String:
